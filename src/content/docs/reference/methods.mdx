...
```
<Alert color="primary">
scatterStyle请参考 <a style="color:" href="/reference/property/#configscatterstyle"><span style="color:#1890ff;">config.scatterStyle</span></a>

pathStyle请参考 <a style="color:" href="/reference/property/#configpathstyle"><span style="color:#1890ff;">config.pathStyle</span></a> 

flyLineStyle请参考 <a style="color:" href="/reference/property/#configflylinestyle"><span style="color:#1890ff;">config.flyLineStyle</span></a> 
